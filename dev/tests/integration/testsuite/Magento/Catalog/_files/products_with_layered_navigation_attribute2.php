...
if (!$attribute->getId()) {
    ...
    $attribute->setData(
        [
            'attribute_code' => 'test_simple_nav_attr_2',
            ...
            'used_for_sort_by' => 1,
            'frontend_label' => ['Test Simple Nav Attr 2'],
            'backend_type' => 'int',
            'option' => [
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ->setId(210)
    ->setAttributeSetId(4)
    ->setName('Simple Product simple_test_2_1')
    ->setSku('nav_product_test_1')
    ->setData('test_simple_nav_attr_2', $optionIds[1])
    ->setTaxClassId('none')
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ->setId(211)
    ->setAttributeSetId(4)
    ->setName('Simple Product simple_test_2_2')
    ->setSku('nav_product_test_2')
    ->setData('test_simple_nav_attr_2', $optionIds[1])
    ->setTaxClassId('none')
    ->setDescription('description')
    ->setShortDescription('short description')
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ->setId(212)
    ->setAttributeSetId(4)
    ->setName('Simple Product simple_test_2_3')
    ->setSku('nav_product_test_3')
    ->setTaxClassId('none')
    ->setDescription('description')
    ->setShortDescription('short description')
    ->setPrice(30)
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ->setId(213)
    ->setAttributeSetId(4)
    ->setName('Simple Product simple_test_2_4')
    ->setSku('nav_product_test_4')
    ->setTaxClassId('none')
    ->setDescription('description')
    ->setShortDescription('short description')
    ->setPrice(30)
