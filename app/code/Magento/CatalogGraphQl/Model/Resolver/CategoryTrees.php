...
/**
 * Categories field resolver, used for GraphQL request processing.
 */
class CategoryTrees implements ResolverInterface
{
    /**
     * @var Builder
     */
    ...
    public function resolve(
        ...
        $data = [
            ...
            'items' => $searchResult->getCategoriesSearchResult(),
            'page_info' => [
