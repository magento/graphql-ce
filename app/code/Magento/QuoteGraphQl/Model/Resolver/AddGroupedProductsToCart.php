...
use Magento\QuoteGraphQl\Model\Cart\AddToCartHandlerResolver;
 ...
 * {@inheritdoc}
 */
class AddGroupedProductsToCart implements ResolverInterface
{
    /**
     * @var ArrayManager
     */
    ...
    /**
     * @var AddToCartHandlerResolver
     */
    private $addToCartHandlerResolver;
     ...
     * @param AddToCartHandlerResolver $addToCartHandlerResolver
     */
    public function __construct(
        ...
        AddToCartHandlerResolver $addToCartHandlerResolver
    ) {
        $this->arrayManager = $arrayManager;
        $this->getCartForUser = $getCartForUser;
        $this->addProductsToCart = $addProductsToCart;
        $this->extractDataFromCart = $extractDataFromCart;
        $this->addToCartHandlerResolver = $addToCartHandlerResolver;
    }
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        $handler = $this->addToCartHandlerResolver->getAddToCartHandler($cartItems);

        $handler->execute($cart, $cartItems);
